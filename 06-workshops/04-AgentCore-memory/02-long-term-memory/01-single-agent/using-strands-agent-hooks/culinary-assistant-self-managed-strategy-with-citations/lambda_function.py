...
{conversation_text}"""
    ...
    def _format_extracted_memories(self, extracted_data, payload, s3_location=None, job_id=None):
        """추출한 Memory를 메타데이터 및 인용 정보와 함께 형식화합니다."""
        memories = []
        ...
        for item in extracted_data:
            ...
            # Long-term Memory를 Short-term Memory 원본에 연결할 인용 정보 구성
            citation_info = {
            ...
            # 콘텐츠에 추가할 수 있도록 인용 정보를 읽기 쉬운 텍스트로 형식화
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # 2. Bedrock 모델을 사용하여 인용 정보가 포함된 Memory 추출
