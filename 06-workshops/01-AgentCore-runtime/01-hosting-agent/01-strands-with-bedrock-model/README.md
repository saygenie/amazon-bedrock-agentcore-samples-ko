# Amazon Bedrock AgentCore Runtime에서 Amazon Bedrock 모델을 사용하는 Strands Agents 호스팅

## 개요

이 자습서에서는 Amazon Bedrock AgentCore Runtime을 사용하여 기존 에이전트를 호스팅하는 방법을 학습합니다.

Amazon Bedrock 모델을 사용하는 Strands Agents 예제에 중점을 둡니다. Amazon Bedrock 모델을 사용하는 LangGraph는 [여기](../02-langgraph-with-bedrock-model)를,
...
| 자습서 구성 요소    | AgentCore Runtime에서 에이전트 호스팅, Strands Agent와 Amazon Bedrock 모델 사용  |
| 자습서 분야         | 여러 산업 분야                                                                    |
| 예제 난이도         | 쉬움                                                                              |
...
데모를 위해 Amazon Bedrock 모델을 사용하는 Strands Agent를 사용합니다.
